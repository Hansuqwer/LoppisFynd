...
abstract final class AppAssets {
  ...
  ///
  /// NOTE: We keep the legacy file (`Assets/unnamed.jpg`) as the canonical source
  /// for now to avoid breaking existing references.
  static const String backgroundLoginMotif = 'Assets/unnamed.jpg';
