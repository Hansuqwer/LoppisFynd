...
- BokFynd ISBN scanner path: run `docs/bokfynd_scanner_qa_plan.md` before any live camera/device test
- BokFynd scanner QA evidence: latest attempt in `docs/qa_evidence/`
