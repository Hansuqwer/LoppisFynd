...
abstract class AppLocalizations {
  ...
  /// No description provided for @scannerBokFyndDraftReady.
  ///
  /// In en, this message translates to:
  /// **'BokFynd draft updated from scanned ISBN.'**
  String get scannerBokFyndDraftReady;

  /// No description provided for @scannerBokFyndIsbnNotFound.
  ///
  /// In en, this message translates to:
  /// **'Scanned ISBN found, but no book metadata matched.'**
  String get scannerBokFyndIsbnNotFound;

  /// No description provided for @scannerBokFyndDraftError.
  ///
  /// In en, this message translates to:
  ...
  /// In en, this message translates to:
  /// **'Back to draft'**
  String get scannerBokFyndReturnToDraft;
  ...
  /// No description provided for @draftEditorBokFyndIsbnTitle.
  ///
  /// In en, this message translates to:
  /// **'BokFynd ISBN'**
  String get draftEditorBokFyndIsbnTitle;

  /// No description provided for @draftEditorBokFyndIsbnHint.
  ///
  /// In en, this message translates to:
  /// **'978...'**
  String get draftEditorBokFyndIsbnHint;

  /// No description provided for @draftEditorBokFyndIsbnTooltip.
  ///
  /// In en, this message translates to:
  /// **'Create BokFynd draft from ISBN'**
  String get draftEditorBokFyndIsbnTooltip;

  /// No description provided for @draftEditorBokFyndScanTooltip.
  ///
  /// In en, this message translates to:
  /// **'Scan ISBN barcode for this draft'**
  String get draftEditorBokFyndScanTooltip;

  /// No description provided for @draftEditorBokFyndIsbnIdle.
  ///
  /// In en, this message translates to:
  /// **'Enter an ISBN to create a BokFynd draft.'**
  String get draftEditorBokFyndIsbnIdle;

  /// No description provided for @draftEditorBokFyndIsbnLoading.
  ///
  /// In en, this message translates to:
  /// **'Looking up book and market data...'**
  String get draftEditorBokFyndIsbnLoading;

  /// No description provided for @draftEditorBokFyndIsbnSuccess.
  ///
  /// In en, this message translates to:
  /// **'BokFynd draft ready.'**
  String get draftEditorBokFyndIsbnSuccess;

  /// No description provided for @draftEditorBokFyndIsbnNotFound.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @bookDecisionTitle.
  ///
  /// In en, this message translates to:
  /// **'Book Details'**
  String get bookDecisionTitle;

  /// No description provided for @bookNoMarketData.
  ///
  /// In en, this message translates to:
  /// **'No market data available for this book.'**
  String get bookNoMarketData;

  /// No description provided for @bookMarketStats.
  ///
  /// In en, this message translates to:
  /// **'Market Stats'**
  String get bookMarketStats;

  /// No description provided for @bookHighestPrice.
  ///
  /// In en, this message translates to:
  /// **'Highest'**
  String get bookHighestPrice;

  /// No description provided for @bookAveragePrice.
  ///
  /// In en, this message translates to:
  /// **'Average'**
  String get bookAveragePrice;

  /// No description provided for @bookLowestPrice.
  ///
  /// In en, this message translates to:
  /// **'Lowest'**
  String get bookLowestPrice;

  /// No description provided for @bookTotalSales.
  ///
  /// In en, this message translates to:
  /// **'Total sales'**
  String get bookTotalSales;

  /// No description provided for @bookSalesPerMonth.
  ///
  /// In en, this message translates to:
  /// **'Sales/month'**
  String get bookSalesPerMonth;

  /// No description provided for @bookPurchasePrice.
  ///
  /// In en, this message translates to:
  /// **'Purchase Price'**
  String get bookPurchasePrice;

  /// No description provided for @bookProfitHint.
  ///
  /// In en, this message translates to:
  /// **'Avg sell price: {price} kr — potential profit!'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Scan books and save them to your inventory.'**
  String get inventoryEmptyHint;

  /// No description provided for @inventoryBoughtFor.
  ///
  /// In en, this message translates to:
  /// **'Bought'**
  String get inventoryBoughtFor;

  /// No description provided for @inventoryAvgSell.
  ///
  /// In en, this message translates to:
  /// **'Avg sell'**
