...
class LoginMotifLayer extends StatelessWidget {
  const LoginMotifLayer({super.key});
                ...
                Positioned(
                  ...
                  child: Opacity(
                    ...
                    child: Transform.rotate(
                      ...
                      child: _MotifMark(size: spec.size),
                    ),
                  ),
                ),
            ],
...
class _MotifMark extends StatelessWidget {
  const _MotifMark({required this.size});
    ...
    return SizedBox(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: AppColors.shadowInk.withAlpha(0x18),
              blurRadius: 22,
