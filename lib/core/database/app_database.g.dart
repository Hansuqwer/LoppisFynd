...
class $BooksTable extends Books with TableInfo<$BooksTable, Book> {
  ...
  static const VerificationMeta _purchasePriceSekMeta = const VerificationMeta(
    'purchasePriceSek',
  );
  @override
  late final GeneratedColumn<int> purchasePriceSek = GeneratedColumn<int>(
    'purchase_price_sek',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  static const VerificationMeta _highestSoldPriceSekMeta =
      const VerificationMeta('highestSoldPriceSek');
  @override
  late final GeneratedColumn<int> highestSoldPriceSek = GeneratedColumn<int>(
  ...
  static const VerificationMeta _averageSoldPriceSekMeta =
      const VerificationMeta('averageSoldPriceSek');
  @override
  late final GeneratedColumn<int> averageSoldPriceSek = GeneratedColumn<int>(
  ...
  static const VerificationMeta _lowestSoldPriceSekMeta =
      const VerificationMeta('lowestSoldPriceSek');
  @override
  late final GeneratedColumn<int> lowestSoldPriceSek = GeneratedColumn<int>(
  ...
  static const VerificationMeta _salesPerMonthMeta = const VerificationMeta(
    'salesPerMonth',
  );
  @override
  late final GeneratedColumn<double> salesPerMonth = GeneratedColumn<double>(
    'sales_per_month',
    aliasedName,
    true,
    type: DriftSqlType.double,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('purchase_price_sek')) {
      context.handle(
        _purchasePriceSekMeta,
        purchasePriceSek.isAcceptableOrUnknown(
          data['purchase_price_sek']!,
          _purchasePriceSekMeta,
        ),
      );
    }
    ...
    if (data.containsKey('highest_sold_price_sek')) {
      context.handle(
        _highestSoldPriceSekMeta,
        highestSoldPriceSek.isAcceptableOrUnknown(
          data['highest_sold_price_sek']!,
          _highestSoldPriceSekMeta,
        ),
      );
    }
    if (data.containsKey('average_sold_price_sek')) {
      context.handle(
        _averageSoldPriceSekMeta,
        averageSoldPriceSek.isAcceptableOrUnknown(
          data['average_sold_price_sek']!,
          _averageSoldPriceSekMeta,
        ),
      );
    }
    if (data.containsKey('lowest_sold_price_sek')) {
      context.handle(
        _lowestSoldPriceSekMeta,
        lowestSoldPriceSek.isAcceptableOrUnknown(
          data['lowest_sold_price_sek']!,
          _lowestSoldPriceSekMeta,
        ),
      );
    }
    if (data.containsKey('sales_per_month')) {
      context.handle(
        _salesPerMonthMeta,
        salesPerMonth.isAcceptableOrUnknown(
  ...
  Book map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Book(
      ...
      purchasePriceSek: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}purchase_price_sek'],
      ),
      saved: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}saved'],
      )!,
      highestSoldPriceSek: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}highest_sold_price_sek'],
      ),
      averageSoldPriceSek: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}average_sold_price_sek'],
      ),
      lowestSoldPriceSek: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}lowest_sold_price_sek'],
      ),
      salesPerMonth: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}sales_per_month'],
      ),
...
class Book extends DataClass implements Insertable<Book> {
  ...
  const Book({
    ...
    this.coverUrl,
    this.categories,
    this.purchasePriceSek,
    required this.saved,
    this.highestSoldPriceSek,
    this.averageSoldPriceSek,
    this.lowestSoldPriceSek,
    this.salesPerMonth,
    this.totalSales,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || purchasePriceSek != null) {
      map['purchase_price_sek'] = Variable<int>(purchasePriceSek);
    }
    map['saved'] = Variable<bool>(saved);
    if (!nullToAbsent || highestSoldPriceSek != null) {
      map['highest_sold_price_sek'] = Variable<int>(highestSoldPriceSek);
    }
    if (!nullToAbsent || averageSoldPriceSek != null) {
      map['average_sold_price_sek'] = Variable<int>(averageSoldPriceSek);
    }
    if (!nullToAbsent || lowestSoldPriceSek != null) {
      map['lowest_sold_price_sek'] = Variable<int>(lowestSoldPriceSek);
    }
    if (!nullToAbsent || salesPerMonth != null) {
      map['sales_per_month'] = Variable<double>(salesPerMonth);
    }
  ...
  BooksCompanion toCompanion(bool nullToAbsent) {
    return BooksCompanion(
      ...
      categories: categories == null && nullToAbsent
          ? const Value.absent()
          : Value(categories),
      purchasePriceSek: purchasePriceSek == null && nullToAbsent
          ? const Value.absent()
          : Value(purchasePriceSek),
      saved: Value(saved),
      highestSoldPriceSek: highestSoldPriceSek == null && nullToAbsent
          ? const Value.absent()
          : Value(highestSoldPriceSek),
      averageSoldPriceSek: averageSoldPriceSek == null && nullToAbsent
          ? const Value.absent()
          : Value(averageSoldPriceSek),
      lowestSoldPriceSek: lowestSoldPriceSek == null && nullToAbsent
          ? const Value.absent()
          : Value(lowestSoldPriceSek),
      salesPerMonth: salesPerMonth == null && nullToAbsent
          ? const Value.absent()
          : Value(salesPerMonth),
  ...
  factory Book.fromJson(
    ...
    return Book(
      ...
      purchasePriceSek: serializer.fromJson<int?>(json['purchasePriceSek']),
      saved: serializer.fromJson<bool>(json['saved']),
      highestSoldPriceSek: serializer.fromJson<int?>(
        json['highestSoldPriceSek'],
      ),
      averageSoldPriceSek: serializer.fromJson<int?>(
        json['averageSoldPriceSek'],
      ),
      lowestSoldPriceSek: serializer.fromJson<int?>(json['lowestSoldPriceSek']),
      salesPerMonth: serializer.fromJson<double?>(json['salesPerMonth']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'purchasePriceSek': serializer.toJson<int?>(purchasePriceSek),
      'saved': serializer.toJson<bool>(saved),
      'highestSoldPriceSek': serializer.toJson<int?>(highestSoldPriceSek),
      'averageSoldPriceSek': serializer.toJson<int?>(averageSoldPriceSek),
      'lowestSoldPriceSek': serializer.toJson<int?>(lowestSoldPriceSek),
      'salesPerMonth': serializer.toJson<double?>(salesPerMonth),
  ...
  Book copyWith({
    ...
    Value<int?> purchasePriceSek = const Value.absent(),
    bool? saved,
    Value<int?> highestSoldPriceSek = const Value.absent(),
    Value<int?> averageSoldPriceSek = const Value.absent(),
    Value<int?> lowestSoldPriceSek = const Value.absent(),
    Value<double?> salesPerMonth = const Value.absent(),
    ...
    purchasePriceSek: purchasePriceSek.present
        ? purchasePriceSek.value
        : this.purchasePriceSek,
    saved: saved ?? this.saved,
    highestSoldPriceSek: highestSoldPriceSek.present
        ? highestSoldPriceSek.value
        : this.highestSoldPriceSek,
    averageSoldPriceSek: averageSoldPriceSek.present
        ? averageSoldPriceSek.value
        : this.averageSoldPriceSek,
    lowestSoldPriceSek: lowestSoldPriceSek.present
        ? lowestSoldPriceSek.value
        : this.lowestSoldPriceSek,
    salesPerMonth: salesPerMonth.present
        ? salesPerMonth.value
        : this.salesPerMonth,
  ...
  Book copyWithCompanion(BooksCompanion data) {
    return Book(
      ...
      categories: data.categories.present
          ...
          : this.categories,
      purchasePriceSek: data.purchasePriceSek.present
          ? data.purchasePriceSek.value
          : this.purchasePriceSek,
      saved: data.saved.present ? data.saved.value : this.saved,
      highestSoldPriceSek: data.highestSoldPriceSek.present
          ? data.highestSoldPriceSek.value
          : this.highestSoldPriceSek,
      averageSoldPriceSek: data.averageSoldPriceSek.present
          ? data.averageSoldPriceSek.value
          : this.averageSoldPriceSek,
      lowestSoldPriceSek: data.lowestSoldPriceSek.present
          ? data.lowestSoldPriceSek.value
          : this.lowestSoldPriceSek,
      salesPerMonth: data.salesPerMonth.present
          ? data.salesPerMonth.value
          : this.salesPerMonth,
  ...
  String toString() {
    return (StringBuffer('Book(')
          ...
          ..write('purchasePriceSek: $purchasePriceSek, ')
          ..write('saved: $saved, ')
          ..write('highestSoldPriceSek: $highestSoldPriceSek, ')
          ..write('averageSoldPriceSek: $averageSoldPriceSek, ')
          ..write('lowestSoldPriceSek: $lowestSoldPriceSek, ')
          ..write('salesPerMonth: $salesPerMonth, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is Book &&
          ...
          other.purchasePriceSek == this.purchasePriceSek &&
          other.saved == this.saved &&
          other.highestSoldPriceSek == this.highestSoldPriceSek &&
          other.averageSoldPriceSek == this.averageSoldPriceSek &&
          other.lowestSoldPriceSek == this.lowestSoldPriceSek &&
          other.salesPerMonth == this.salesPerMonth &&
...
class BooksCompanion extends UpdateCompanion<Book> {
  ...
  final Value<int?> purchasePriceSek;
  final Value<bool> saved;
  final Value<int?> highestSoldPriceSek;
  final Value<int?> averageSoldPriceSek;
  final Value<int?> lowestSoldPriceSek;
  final Value<double?> salesPerMonth;
  ...
  const BooksCompanion({
    ...
    this.purchasePriceSek = const Value.absent(),
    this.saved = const Value.absent(),
    this.highestSoldPriceSek = const Value.absent(),
    this.averageSoldPriceSek = const Value.absent(),
    this.lowestSoldPriceSek = const Value.absent(),
    this.salesPerMonth = const Value.absent(),
  ...
  static Insertable<Book> custom({
    ...
    Expression<int>? purchasePriceSek,
    Expression<bool>? saved,
    Expression<int>? highestSoldPriceSek,
    Expression<int>? averageSoldPriceSek,
    Expression<int>? lowestSoldPriceSek,
    Expression<double>? salesPerMonth,
    ...
    return RawValuesInsertable({
      ...
      if (purchasePriceSek != null) 'purchase_price_sek': purchasePriceSek,
      if (saved != null) 'saved': saved,
      if (highestSoldPriceSek != null)
        'highest_sold_price_sek': highestSoldPriceSek,
      if (averageSoldPriceSek != null)
        'average_sold_price_sek': averageSoldPriceSek,
      if (lowestSoldPriceSek != null)
        'lowest_sold_price_sek': lowestSoldPriceSek,
      if (salesPerMonth != null) 'sales_per_month': salesPerMonth,
  ...
  BooksCompanion copyWith({
    ...
    Value<int?>? purchasePriceSek,
    Value<bool>? saved,
    Value<int?>? highestSoldPriceSek,
    Value<int?>? averageSoldPriceSek,
    Value<int?>? lowestSoldPriceSek,
    Value<double?>? salesPerMonth,
    ...
    return BooksCompanion(
      ...
      purchasePriceSek: purchasePriceSek ?? this.purchasePriceSek,
      saved: saved ?? this.saved,
      highestSoldPriceSek: highestSoldPriceSek ?? this.highestSoldPriceSek,
      averageSoldPriceSek: averageSoldPriceSek ?? this.averageSoldPriceSek,
      lowestSoldPriceSek: lowestSoldPriceSek ?? this.lowestSoldPriceSek,
      salesPerMonth: salesPerMonth ?? this.salesPerMonth,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (purchasePriceSek.present) {
      map['purchase_price_sek'] = Variable<int>(purchasePriceSek.value);
    }
    if (saved.present) {
      map['saved'] = Variable<bool>(saved.value);
    }
    if (highestSoldPriceSek.present) {
      map['highest_sold_price_sek'] = Variable<int>(highestSoldPriceSek.value);
    }
    if (averageSoldPriceSek.present) {
      map['average_sold_price_sek'] = Variable<int>(averageSoldPriceSek.value);
    }
    if (lowestSoldPriceSek.present) {
      map['lowest_sold_price_sek'] = Variable<int>(lowestSoldPriceSek.value);
    }
    if (salesPerMonth.present) {
      map['sales_per_month'] = Variable<double>(salesPerMonth.value);
    }
...
class $BookMarketDataTable extends BookMarketData
    with TableInfo<$BookMarketDataTable, BookMarketDataData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $BookMarketDataTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  static const VerificationMeta _priceSekMeta = const VerificationMeta(
    'priceSek',
  );
  @override
  late final GeneratedColumn<int> priceSek = GeneratedColumn<int>(
    'price_sek',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  static const VerificationMeta _listingUrlMeta = const VerificationMeta(
    'listingUrl',
  );
  @override
  late final GeneratedColumn<String> listingUrl = GeneratedColumn<String>(
    'listing_url',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'book_market_data';
  @override
  VerificationContext validateIntegrity(
    Insertable<BookMarketDataData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('price_sek')) {
      context.handle(
        _priceSekMeta,
        priceSek.isAcceptableOrUnknown(data['price_sek']!, _priceSekMeta),
      );
    } else if (isInserting) {
      context.missing(_priceSekMeta);
    }
    ...
    if (data.containsKey('listing_url')) {
      context.handle(
        _listingUrlMeta,
        listingUrl.isAcceptableOrUnknown(data['listing_url']!, _listingUrlMeta),
      );
    }
    if (data.containsKey('fetched_at')) {
      context.handle(
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  BookMarketDataData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return BookMarketDataData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
      ...
      priceSek: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}price_sek'],
      )!,
      soldAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}sold_at'],
      )!,
      listingUrl: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}listing_url'],
      ),
      fetchedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}fetched_at'],
  ...
  @override
  $BookMarketDataTable createAlias(String alias) {
    return $BookMarketDataTable(attachedDatabase, alias);
  }
}

class BookMarketDataData extends DataClass
    implements Insertable<BookMarketDataData> {
  final String id;
  final String bookId;
  final String isbn;
  final String platform;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['isbn'] = Variable<String>(isbn);
    map['platform'] = Variable<String>(platform);
    map['price_sek'] = Variable<int>(priceSek);
    map['sold_at'] = Variable<DateTime>(soldAt);
    if (!nullToAbsent || listingUrl != null) {
      map['listing_url'] = Variable<String>(listingUrl);
    }
    map['fetched_at'] = Variable<DateTime>(fetchedAt);
    return map;
  }

  BookMarketDataCompanion toCompanion(bool nullToAbsent) {
    return BookMarketDataCompanion(
      id: Value(id),
      bookId: Value(bookId),
      isbn: Value(isbn),
      platform: Value(platform),
      ...
      soldAt: Value(soldAt),
      listingUrl: listingUrl == null && nullToAbsent
          ? const Value.absent()
          : Value(listingUrl),
      fetchedAt: Value(fetchedAt),
    );
  ...
  factory BookMarketDataData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return BookMarketDataData(
      ...
      isbn: serializer.fromJson<String>(json['isbn']),
      platform: serializer.fromJson<String>(json['platform']),
      priceSek: serializer.fromJson<int>(json['priceSek']),
      soldAt: serializer.fromJson<DateTime>(json['soldAt']),
      listingUrl: serializer.fromJson<String?>(json['listingUrl']),
      fetchedAt: serializer.fromJson<DateTime>(json['fetchedAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'isbn': serializer.toJson<String>(isbn),
      'platform': serializer.toJson<String>(platform),
      'priceSek': serializer.toJson<int>(priceSek),
      'soldAt': serializer.toJson<DateTime>(soldAt),
      'listingUrl': serializer.toJson<String?>(listingUrl),
      'fetchedAt': serializer.toJson<DateTime>(fetchedAt),
    };
  }

  BookMarketDataData copyWith({
    String? id,
    String? bookId,
    String? isbn,
    String? platform,
    int? priceSek,
    DateTime? soldAt,
    Value<String?> listingUrl = const Value.absent(),
    DateTime? fetchedAt,
  }) => BookMarketDataData(
    id: id ?? this.id,
    ...
    isbn: isbn ?? this.isbn,
    platform: platform ?? this.platform,
    priceSek: priceSek ?? this.priceSek,
    soldAt: soldAt ?? this.soldAt,
    listingUrl: listingUrl.present ? listingUrl.value : this.listingUrl,
    fetchedAt: fetchedAt ?? this.fetchedAt,
  );
  BookMarketDataData copyWithCompanion(BookMarketDataCompanion data) {
    return BookMarketDataData(
      id: data.id.present ? data.id.value : this.id,
      bookId: data.bookId.present ? data.bookId.value : this.bookId,
      isbn: data.isbn.present ? data.isbn.value : this.isbn,
      platform: data.platform.present ? data.platform.value : this.platform,
      priceSek: data.priceSek.present ? data.priceSek.value : this.priceSek,
      soldAt: data.soldAt.present ? data.soldAt.value : this.soldAt,
      listingUrl: data.listingUrl.present
          ? data.listingUrl.value
          : this.listingUrl,
      fetchedAt: data.fetchedAt.present ? data.fetchedAt.value : this.fetchedAt,
    );
  }
  ...
  @override
  String toString() {
    return (StringBuffer('BookMarketDataData(')
          ..write('id: $id, ')
          ..write('bookId: $bookId, ')
          ..write('isbn: $isbn, ')
          ..write('platform: $platform, ')
          ..write('priceSek: $priceSek, ')
          ..write('soldAt: $soldAt, ')
          ..write('listingUrl: $listingUrl, ')
          ..write('fetchedAt: $fetchedAt')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is BookMarketDataData &&
          other.id == this.id &&
          other.bookId == this.bookId &&
          other.isbn == this.isbn &&
          other.platform == this.platform &&
          other.priceSek == this.priceSek &&
          other.soldAt == this.soldAt &&
          other.listingUrl == this.listingUrl &&
          other.fetchedAt == this.fetchedAt);
}

class BookMarketDataCompanion extends UpdateCompanion<BookMarketDataData> {
  final Value<String> id;
  final Value<String> bookId;
  final Value<String> isbn;
  final Value<String> platform;
  final Value<int> priceSek;
  final Value<DateTime> soldAt;
  final Value<String?> listingUrl;
  final Value<DateTime> fetchedAt;
  final Value<int> rowid;
  const BookMarketDataCompanion({
    this.id = const Value.absent(),
    this.bookId = const Value.absent(),
    this.isbn = const Value.absent(),
    this.platform = const Value.absent(),
    this.priceSek = const Value.absent(),
    this.soldAt = const Value.absent(),
    this.listingUrl = const Value.absent(),
    this.fetchedAt = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  BookMarketDataCompanion.insert({
    required String id,
    ...
    this.rowid = const Value.absent(),
       ...
       soldAt = Value(soldAt),
       fetchedAt = Value(fetchedAt);
  static Insertable<BookMarketDataData> custom({
    Expression<String>? id,
    Expression<String>? bookId,
    Expression<String>? isbn,
    Expression<String>? platform,
    Expression<int>? priceSek,
    Expression<DateTime>? soldAt,
    Expression<String>? listingUrl,
    Expression<DateTime>? fetchedAt,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
      ...
      if (isbn != null) 'isbn': isbn,
      if (platform != null) 'platform': platform,
      if (priceSek != null) 'price_sek': priceSek,
  ...
  BookMarketDataCompanion copyWith({
    Value<String>? id,
    Value<String>? bookId,
    Value<String>? isbn,
    Value<String>? platform,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (priceSek.present) {
      map['price_sek'] = Variable<int>(priceSek.value);
    }
    if (soldAt.present) {
      map['sold_at'] = Variable<DateTime>(soldAt.value);
    }
    if (listingUrl.present) {
      map['listing_url'] = Variable<String>(listingUrl.value);
    }
    if (fetchedAt.present) {
      map['fetched_at'] = Variable<DateTime>(fetchedAt.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('BookMarketDataCompanion(')
          ..write('id: $id, ')
          ..write('bookId: $bookId, ')
          ..write('isbn: $isbn, ')
          ..write('platform: $platform, ')
...
class $PriceButtonConfigTable extends PriceButtonConfig
    with TableInfo<$PriceButtonConfigTable, PriceButtonConfigData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $PriceButtonConfigTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  List<GeneratedColumn> get $columns => [position, priceSek];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'price_button_config';
  @override
  VerificationContext validateIntegrity(
    Insertable<PriceButtonConfigData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  PriceButtonConfigData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PriceButtonConfigData(
  ...
  @override
  $PriceButtonConfigTable createAlias(String alias) {
    return $PriceButtonConfigTable(attachedDatabase, alias);
  }
}

class PriceButtonConfigData extends DataClass
    implements Insertable<PriceButtonConfigData> {
  final int position;
  final int priceSek;
  const PriceButtonConfigData({required this.position, required this.priceSek});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  PriceButtonConfigCompanion toCompanion(bool nullToAbsent) {
    return PriceButtonConfigCompanion(
      position: Value(position),
      priceSek: Value(priceSek),
    );
  }

  factory PriceButtonConfigData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  PriceButtonConfigData copyWith({int? position, int? priceSek}) =>
      PriceButtonConfigData(
        position: position ?? this.position,
        priceSek: priceSek ?? this.priceSek,
      );
  PriceButtonConfigData copyWithCompanion(PriceButtonConfigCompanion data) {
    return PriceButtonConfigData(
  ...
  @override
  String toString() {
    return (StringBuffer('PriceButtonConfigData(')
  ...
  @override
  int get hashCode => Object.hash(position, priceSek);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PriceButtonConfigData &&
          other.position == this.position &&
          other.priceSek == this.priceSek);
}

class PriceButtonConfigCompanion
    extends UpdateCompanion<PriceButtonConfigData> {
  final Value<int> position;
  final Value<int> priceSek;
  const PriceButtonConfigCompanion({
    this.position = const Value.absent(),
    this.priceSek = const Value.absent(),
  });
  PriceButtonConfigCompanion.insert({
    this.position = const Value.absent(),
    required int priceSek,
  }) : priceSek = Value(priceSek);
  static Insertable<PriceButtonConfigData> custom({
  ...
  PriceButtonConfigCompanion copyWith({
    Value<int>? position,
    Value<int>? priceSek,
  }) {
    return PriceButtonConfigCompanion(
  ...
  @override
  String toString() {
    return (StringBuffer('PriceButtonConfigCompanion(')
          ..write('position: $position, ')
          ..write('priceSek: $priceSek')
          ..write(')'))
        .toString();
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $BookMarketDataTable bookMarketData = $BookMarketDataTable(this);
  late final $PriceButtonConfigTable priceButtonConfig =
      $PriceButtonConfigTable(this);
  ...
  late final BookMarketDataDao bookMarketDataDao = BookMarketDataDao(
    this as AppDatabase,
  );
  late final PriceButtonConfigDao priceButtonConfigDao = PriceButtonConfigDao(
    this as AppDatabase,
  );
  @override
...
class $$BooksTableFilterComposer extends Composer<_$AppDatabase, $BooksTable> {
  ...
  ColumnFilters<int> get purchasePriceSek => $composableBuilder(
    column: $table.purchasePriceSek,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<int> get highestSoldPriceSek => $composableBuilder(
    column: $table.highestSoldPriceSek,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<int> get averageSoldPriceSek => $composableBuilder(
    column: $table.averageSoldPriceSek,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<int> get lowestSoldPriceSek => $composableBuilder(
    column: $table.lowestSoldPriceSek,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<double> get salesPerMonth => $composableBuilder(
    column: $table.salesPerMonth,
    builder: (column) => ColumnFilters(column),
  );
...
class $$BooksTableOrderingComposer
  ...
  ColumnOrderings<int> get purchasePriceSek => $composableBuilder(
    column: $table.purchasePriceSek,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<int> get highestSoldPriceSek => $composableBuilder(
    column: $table.highestSoldPriceSek,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<int> get averageSoldPriceSek => $composableBuilder(
    column: $table.averageSoldPriceSek,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<int> get lowestSoldPriceSek => $composableBuilder(
    column: $table.lowestSoldPriceSek,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<double> get salesPerMonth => $composableBuilder(
    column: $table.salesPerMonth,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$BooksTableAnnotationComposer
  ...
  GeneratedColumn<int> get purchasePriceSek => $composableBuilder(
    column: $table.purchasePriceSek,
    builder: (column) => column,
  );
  ...
  GeneratedColumn<int> get highestSoldPriceSek => $composableBuilder(
    column: $table.highestSoldPriceSek,
    builder: (column) => column,
  );

  GeneratedColumn<int> get averageSoldPriceSek => $composableBuilder(
    column: $table.averageSoldPriceSek,
    builder: (column) => column,
  );

  GeneratedColumn<int> get lowestSoldPriceSek => $composableBuilder(
    column: $table.lowestSoldPriceSek,
    builder: (column) => column,
  );

  GeneratedColumn<double> get salesPerMonth => $composableBuilder(
    column: $table.salesPerMonth,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                saved: saved,
                highestSoldPriceSek: highestSoldPriceSek,
                averageSoldPriceSek: averageSoldPriceSek,
                lowestSoldPriceSek: lowestSoldPriceSek,
...
typedef $$BooksTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$BookMarketDataTableCreateCompanionBuilder =
    BookMarketDataCompanion Function({
      required String id,
      required String bookId,
      required String isbn,
      required String platform,
...
typedef $$BookMarketDataTableUpdateCompanionBuilder =
    BookMarketDataCompanion Function({
      Value<String> id,
      Value<String> bookId,
      Value<String> isbn,
...
class $$BookMarketDataTableFilterComposer
    extends Composer<_$AppDatabase, $BookMarketDataTable> {
  $$BookMarketDataTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<int> get priceSek => $composableBuilder(
    column: $table.priceSek,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<String> get listingUrl => $composableBuilder(
    column: $table.listingUrl,
    builder: (column) => ColumnFilters(column),
  );
...
class $$BookMarketDataTableOrderingComposer
    extends Composer<_$AppDatabase, $BookMarketDataTable> {
  $$BookMarketDataTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<int> get priceSek => $composableBuilder(
    column: $table.priceSek,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<String> get listingUrl => $composableBuilder(
    column: $table.listingUrl,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$BookMarketDataTableAnnotationComposer
    extends Composer<_$AppDatabase, $BookMarketDataTable> {
  $$BookMarketDataTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<int> get priceSek =>
      $composableBuilder(column: $table.priceSek, builder: (column) => column);

  GeneratedColumn<DateTime> get soldAt =>
      $composableBuilder(column: $table.soldAt, builder: (column) => column);

  GeneratedColumn<String> get listingUrl => $composableBuilder(
    column: $table.listingUrl,
    builder: (column) => column,
  );
...
class $$BookMarketDataTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $BookMarketDataTable,
          ...
          $$BookMarketDataTableOrderingComposer,
          $$BookMarketDataTableAnnotationComposer,
          $$BookMarketDataTableCreateCompanionBuilder,
          $$BookMarketDataTableUpdateCompanionBuilder,
          (
            BookMarketDataData,
            BaseReferences<
              _$AppDatabase,
  ...
  $$BookMarketDataTableTableManager(
    _$AppDatabase db,
    $BookMarketDataTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$BookMarketDataTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$BookMarketDataTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$BookMarketDataTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                ...
                Value<String> isbn = const Value.absent(),
                Value<String> platform = const Value.absent(),
                Value<int> priceSek = const Value.absent(),
...
typedef $$BookMarketDataTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $BookMarketDataTable,
      BookMarketDataData,
      ...
      (
        BookMarketDataData,
        BaseReferences<_$AppDatabase, $BookMarketDataTable, BookMarketDataData>,
      ),
      BookMarketDataData,
      PrefetchHooks Function()
    >;
typedef $$PriceButtonConfigTableCreateCompanionBuilder =
    PriceButtonConfigCompanion Function({
      Value<int> position,
      required int priceSek,
    });
typedef $$PriceButtonConfigTableUpdateCompanionBuilder =
    PriceButtonConfigCompanion Function({
      Value<int> position,
      Value<int> priceSek,
    });

class $$PriceButtonConfigTableFilterComposer
    extends Composer<_$AppDatabase, $PriceButtonConfigTable> {
  $$PriceButtonConfigTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PriceButtonConfigTableOrderingComposer
    extends Composer<_$AppDatabase, $PriceButtonConfigTable> {
  $$PriceButtonConfigTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PriceButtonConfigTableAnnotationComposer
    extends Composer<_$AppDatabase, $PriceButtonConfigTable> {
  $$PriceButtonConfigTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PriceButtonConfigTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $PriceButtonConfigTable,
          PriceButtonConfigData,
          $$PriceButtonConfigTableFilterComposer,
          $$PriceButtonConfigTableOrderingComposer,
          $$PriceButtonConfigTableAnnotationComposer,
          $$PriceButtonConfigTableCreateCompanionBuilder,
          $$PriceButtonConfigTableUpdateCompanionBuilder,
          (
            PriceButtonConfigData,
            BaseReferences<
              _$AppDatabase,
  ...
  $$PriceButtonConfigTableTableManager(
    _$AppDatabase db,
    $PriceButtonConfigTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$PriceButtonConfigTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$PriceButtonConfigTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$PriceButtonConfigTableAnnotationComposer(
                $db: db,
                $table: table,
...
typedef $$PriceButtonConfigTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $PriceButtonConfigTable,
      PriceButtonConfigData,
...
class $AppDatabaseManager {
  ...
  $$BookMarketDataTableTableManager get bookMarketData =>
      $$BookMarketDataTableTableManager(_db, _db.bookMarketData);
  $$PriceButtonConfigTableTableManager get priceButtonConfig =>
      $$PriceButtonConfigTableTableManager(_db, _db.priceButtonConfig);
}
