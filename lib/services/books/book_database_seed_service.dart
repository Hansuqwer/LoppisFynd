...
class BookDatabaseSeedService {
  ...
  Future<void> ensureSeeded() async {
    ...
    final count = await _db.customSelect('SELECT COUNT(1) AS c FROM books').getSingle();
    ...
    await _db.transaction(() async {
      for (final b in _seedBooks) {
        await _db.booksDao.upsert(
          id: b.isbn, // We use isbn as internal id for seeded books to prevent duplicates
          isbn: b.isbn,
          title: b.title,
          author: b.author,
          coverUrl: b.coverUrl,
